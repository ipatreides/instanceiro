...
"[project]/instance-tracker/.claude/worktrees/calm-bubbling-raven/src/app/auth/callback/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request) {
    ...
    if (code) {
        ...
        if (!error) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$instance$2d$tracker$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}${target}`);
        }
        ...
        const redirect = searchParams.get("redirect") ?? "";
        return __TURBOPACK__imported__module__$5b$project$5d2f$instance$2d$tracker$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/auth/callback-client?code=${encodeURIComponent(code)}&redirect=${encodeURIComponent(redirect)}`);
    }
    return __TURBOPACK__imported__module__$5b$project$5d2f$instance$2d$tracker$2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].redirect(`${origin}/?error=auth`);
}
}),
];

//# sourceMappingURL=%5Broot-of-the-server%5D__1f048b19._.js.map