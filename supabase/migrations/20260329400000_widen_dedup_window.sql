-- Widen dedup window to 59 minutes and remove p_update_only
-- No MVP respawns faster than 1 hour, so 59min safely deduplicates all sources
-- Tomb clicks (even hours later) will match by MVP + approximate kill time
...
BEGIN
  ...
  v_dedup_cutoff := p_killed_at - INTERVAL '59 minutes';
