    ...
    <div className="min-h-screen flex items-center justify-center bg-[#0f0a1a] px-4">
      <div className="w-full max-w-md bg-[#1a1230] rounded-2xl p-8 border border-[#3D2A5C]">
        ...
        <p className="text-[#A89BC2] text-center mb-6">
          Acesse sua conta no Instanceiro
        </p>
        ...
        <div className="flex items-center gap-3 my-6">
          ...
          <span className="text-sm text-[#6B5A8A]">ou</span>
          <div className="flex-1 h-px bg-[#3D2A5C]" />
        </div>

        <button
          onClick={handleGoogleLogin}
          className="w-full py-2.5 rounded-lg bg-[#2a1f40] border border-[#3D2A5C] text-white font-medium hover:bg-[#3D2A5C] transition flex items-center justify-center gap-2"
        >
