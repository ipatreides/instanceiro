              ...
              {editingId === completion.id ? (
                ...
                <>
                  <div className="flex items-center gap-2 min-w-0">
                    <span className="text-xs text-[#7C3AED] font-medium shrink-0">
                    ...
                    <button
                      ...
                      className="text-sm text-[#A89BC2] hover:text-white transition-colors cursor-pointer truncate"
                  ...
                  {mostRecentByChar.has(completion.id) && (
                    <button
                      ...
                      disabled={actionLoading}
                      className="text-xs text-red-400 hover:text-red-300 transition-colors cursor-pointer disabled:opacity-50 disabled:cursor-not-allowed shrink-0 ml-2"
